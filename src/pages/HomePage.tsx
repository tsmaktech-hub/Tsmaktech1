  ...
  return (
    <div className="relative w-full overflow-x-hidden">
      ...
      <motion.section 
        ...
        className="py-12 sm:py-16 relative border-b border-white/[0.08] overflow-hidden"
      >
        {/* Subtle section radial ambient stage depth */}
        <div 
          className="absolute inset-0 pointer-events-none -z-10"
          style={{
            background: 'radial-gradient(ellipse 65% 50% at 50% 50%, rgba(37, 99, 235, 0.08) 0%, transparent 80%)',
          }}
        />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-6 gap-4">
            <div>
              <span className="text-[11px] font-mono font-bold tracking-widest text-blue-400 uppercase mb-1.5 block">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-semibold text-blue-400 hover:text-blue-300 transition-colors group px-3 py-1.5 rounded-lg hover:bg-blue-500/10 cursor-pointer"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <AnimatePresence mode="wait">
            {dualMode === 'studio' ? (
              ...
              >
                {/* Visual Card 1 */}
                <TiltCard className="p-4 sm:p-5 rounded-2xl bg-[#0c101c] border border-white/10 hover:border-blue-500/30 transition-all flex flex-col justify-between group h-full">
                  <div>
              ...
              >
                ...
                <TiltCard className="p-4 sm:p-5 rounded-2xl bg-[#0c101c] border border-white/10 hover:border-blue-500/30 transition-all flex flex-col justify-between group h-full">
                  ...
                  <div className="pt-3 border-t border-white/5 text-[11px] text-blue-400 font-mono">
                ...
                <TiltCard className="p-4 sm:p-5 rounded-2xl bg-[#0c101c] border border-white/10 hover:border-blue-500/30 transition-all flex flex-col justify-between group h-full">
                  ...
                  <a
                    ...
                    className="pt-3 border-t border-white/5 text-[11px] text-blue-400 font-semibold flex items-center justify-between hover:underline"
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-6 space-y-4 text-left">
              ...
              <div className="flex flex-wrap gap-1.5 pt-1">
                {PRESET_QUERIES.map((q) => (
                  <button
                    ...
                    className="px-2.5 py-1 rounded-full text-[11px] font-mono bg-white/[0.04] hover:bg-white/[0.08] text-zinc-300 border border-white/10 hover:border-white/20 transition-colors text-left truncate max-w-full cursor-pointer"
                  >
                    + {q}
                  </button>
                ))}
              ...
              {/* Input Form */}
              <div className="p-1.5 rounded-xl bg-[#0c101c] border border-white/10 flex flex-col sm:flex-row gap-2 shadow-sm">
                <input
                  type="text"
                  value={searchQuery}
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-semibold text-xs transition-colors disabled:opacity-50 whitespace-nowrap flex items-center justify-center gap-1.5 active:scale-95 cursor-pointer shadow-sm"
                >
                  {isAiLoading ? (
            ...
            <div className="lg:col-span-6">
              {aiRecommendation ? (
                <motion.div
                  ...
                  className="p-5 rounded-2xl bg-[#0c101c] border border-white/10 text-left relative shadow-lg"
                >
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {FEATURED_TUTORIALS.map((tutorial, idx) => (
              <TiltCard
                key={tutorial.id}
                tiltAngle={6}
                className="rounded-2xl bg-[#0c101c] border border-white/10 hover:border-blue-500/30 transition-all p-4 flex flex-col justify-between group h-full cursor-pointer"
                onClick={() => onNavigate('get-started')}
              >
                <div>
                  ...
                  <div className="flex items-center gap-1.5 text-[11px] text-zinc-400 font-mono mb-1.5">
                    ...
                    <span>•</span>
                    <span className="text-blue-400">{tutorial.duration}</span>
                  </div>

                  <h3 className="text-base font-bold text-white mb-1.5 group-hover:text-blue-300 transition-colors font-display">
                    {tutorial.title}
                  </h3>
